...
class ToggleButtonWrapper extends React.Component {
  ...
  handleToggle(e) {
    ...
    this.setState({ isOn: !this.state.isOn, text: this.state.isOn ? 'MINIMAX': 'NAIVE AI' });
  }
...
const Switch = function (props) {
  ...
  return (
    React.createElement("div", { className: classNames, onClick: props.handleToggle },
    React.createElement(ToggleButton, {
      isOn: props.isOn, text: props.text })));
};
